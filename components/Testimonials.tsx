        ...
        <div className="flex gap-6 overflow-x-auto pb-12 snap-x snap-mandatory hide-scrollbar">
          {data.items.map((item: any, i: number) => (
            <motion.div 
              ...
              className="min-w-[300px] md:min-w-[400px] bg-bg-tint p-8 rounded-3xl snap-center shrink-0"
            >
              ...
              <p className="text-text-main text-lg mb-8 leading-relaxed">"{item.text}"</p>
